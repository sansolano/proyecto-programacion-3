   ...
   <body>
      <footer class="footer-distributed" style="margin-top: 0;">
         <div class="footer-left">
            <p style="color: black;">GRUPO LA CAZADORA R.L.</p>
            <br>	
            <p class="footer-company-name">Copyright © 2024.</p>
            <br>
            <p class="footer-company-name">Todos los derechos reservados.</p>
            <br>
         ...
         <div class="footer-right">
            ...
            <p style="text-align: justify;" class="footer-company-name">Compremetidos con el carbono neutral, además con el buen servicio hacia ustedes, en busca de la excelencia y la buena relación con el medio ambiente.</p>
            <br>
