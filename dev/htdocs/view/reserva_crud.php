<?php
   ...
   $sql = "SELECT * FROM crud_reservas WHERE usuario = '$usuario'";
         ...
         <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
               <li class="sidebar-item">
                  <a href="../view/dashboard_client.php" class="sidebar-link">
               ...
               <li class="sidebar-item">
                  <a href="../view/reserva_crud.php" class="sidebar-link">
            ...
            <div class="sidebar-footer">
               <a href="../view/homepage.php" class="sidebar-link">
                  ...
                  <script>
                     function actualizarCampos() {
                         ...
                         if (opciones.value === "Alajuela - San José") {
                             kilometros.value = "60 km";
                             tiempo.value = "40 asientos";
                             peajes.value = "740";
                         } else if (opciones.value === "Alajuela - Aurora") {
                             kilometros.value = "45 km";
                             tiempo.value = "50 asientos";
                             peajes.value = "335";
                         } else if (opciones.value === "Alajuela - San Juan") {
                             kilometros.value = "30 km";
                             tiempo.value = "60 asientos";
                             peajes.value = "240";
                         } else {
                             kilometros.value = "";
                             tiempo.value = "";
